    ...
    <div class="table-responsive">
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-6">
                        <h2><b>Gestión &nbsp;Usuarios</b></h2>
                    </div>
                    <div class="col-sm-6">
                        <a href="#addEmployeeModal" class="btn btn-success" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Control Usuario</span></a>
            ...
            <table class="table table-striped table-hover">
                ...
                <% for(int i = 0; i <  arregloUsuario.Length; i++ ){%>
                        ...
                        <td><% Response.Write(arregloUsuario[i].NomUsuario); %></td>
                         <td></td>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
                <div class="modal-header">						
                    <h4 class="modal-title"><center>Usuarios</center></h4>
                ...
                <div class="modal-body">
                    <div class="form-group">
                      ...
                      <ul class="nav nav-tabs" role="tablist">
                        <li class="nav-item">
                          <a class="nav-link active" data-toggle="tab" href="#usu">Dato Usuario</a>
                        </li>
                        <li class="nav-item">
                          <a class="nav-link" data-toggle="tab" href="#rolus">Roles por Usuario</a>
                        </li>
                      </ul>
                ...
                <div id="usu" class="container tab-pane active"><br>
                         <!-- <h3>Dato Usuario</h3>
                          <p>Ingrese los datos  de usurio</p>-->
                         <div class="form-group">
                        <label>Nombre Usuario</label>
                        <asp:TextBox ID="txtNomUsuario" runat="server" class="form-control" required></asp:TextBox>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div id="rolus" class="container tab-pane fade"><br>
                              <div class="form-group">
                                <label for="Rol">Rol</label>
                                <asp:DropDownList ID="DropDownList1" runat="server" class="form-control"></asp:DropDownList>
                              </div>
                              <div class="form-group">
                                <label for="RolUs">Roles de Usuario</label>
                                </select>
