<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FrmFrecuencia.aspx.cs" Inherits="proyecto_sisevid.FrmFrecuencia" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <title></title>
		<link rel="stylesheet" href="~/Content/Frecuencia.css" />
	...
	<div class="table-responsive">
		<div class="table-wrapper">
			<div class="table-title">
				<div class="row">
					<div class="col-sm-6">
						<h2><b>Gestor de Frecuencia</b></h2>
					</div>
					<div class="col-sm-6">
						<a href="#addEmployeeModal" class="btn btn-success" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Agregar Frecuencia</span></a>
