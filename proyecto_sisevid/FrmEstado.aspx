<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FrmEstado.aspx.cs" Inherits="proyecto_sisevid.FrmEstado" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <title></title>
		...
		<link rel="stylesheet" href="~/Content/Estado.css" />
</head>
<body>
	...
	<div class="table-responsive">
		<div class="table-wrapper">
			...
			<table class="table table-striped table-hover">
				...
				<tbody>
                    <% for(int i = 0; i <  arregloEstado.Length; i++ ){%>
                        <tr>
						<td>
							<span class="custom-checkbox">
                        ...
                        <td><% Response.Write(arregloEstado[i].Id); %></td>
                         <td></td>
                        <td><% Response.Write(arregloEstado[i].Nom); %></td>
                         <td></td>
                        <td>
		...
		<div class="modal-content">
			<form>
				...
				<div class="modal-footer">
					...
					<asp:Button ID="Button2" runat="server" Text="Modifica" OnClick="Page_Load" OnCommand="btnModificar" class="btn btn-outline-warning"/>
					<asp:Button ID="Button3" runat="server" Text="Consultar" OnClick="Page_Load" OnCommand="brnConsultar" class="btn btn-outline-primary"/>
