<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FrmUnidadDeMedicion.aspx.cs" Inherits="proyecto_sisevid.FrmUnidadDeMedicion" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <title></title>
		...
		<link rel="stylesheet" href="~/Content/UnidadDeMedicion.css" />
</head>
<body>
	...
	<div class="table-responsive">
		<div class="table-wrapper">
			<div class="table-title">
				<div class="row">
					<div class="col-sm-6">
						<h2><b>Gestor de Medición</b></h2>
					</div>
					<div class="col-sm-6">
						<a href="#addEmployeeModal" class="btn btn-success" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Agregar Medición</span></a>
			...
			<table class="table table-striped table-hover">
				...
				<tbody>
					<%try
						{  %>
                    <% for (int i = 0; i < arregloUnidadDeMedicion.Length; i++)
						{%>
                        <tr>
						<td>
							<span class="custom-checkbox">
                        ...
                        <td><% Response.Write(arregloUnidadDeMedicion[i].Id); %></td>
                         <td></td>
                        <td><% Response.Write(arregloUnidadDeMedicion[i].Descripcion); %></td>
                         <td></td>
                        <td>
  ...
  <div id="editEmployeeModal" class="modal fade">
	<div class="modal-dialog">
		<div class="modal-content">
			<form>
				<div class="modal-header">						
					<h4 class="modal-title">Edit Medición</h4>
					<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
				</div>
				<div class="modal-body">					
					<div class="form-group">
