<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FrmFuente.aspx.cs" Inherits="proyecto_sisevid.FrmFuente" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <title></title>
		...
		<link rel="stylesheet" href="~/Content/Fuente.css" />
</head>
<body>
				...
				<tbody>
                    <% for(int i = 0; i <  arregloFuente.Length; i++ ){%>
                        ...
                        <td><% Response.Write(arregloFuente[i].Id); %></td>
                         <td></td>
                        <td><% Response.Write(arregloFuente[i].Nom); %></td>
                         <td></td>
                        <td>
